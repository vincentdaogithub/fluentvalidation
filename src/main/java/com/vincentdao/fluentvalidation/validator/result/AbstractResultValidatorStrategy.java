...
public abstract class AbstractResultValidatorStrategy<S extends AbstractResultValidatorStrategy<S, P, V>, P extends AbstractResultValidator<P, V>, V>
        extends AbstractValidatorStrategy<S, P, V> {
