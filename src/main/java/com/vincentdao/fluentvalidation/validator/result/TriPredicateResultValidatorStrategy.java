...
public abstract class TriPredicateResultValidatorStrategy<S extends TriPredicateResultValidatorStrategy<S, P, V, O, A>, P extends AbstractResultValidator<P, V>, V, O, A>
        extends AbstractResultValidatorStrategy<S, P, V> {

    private final O other;
    private final A another;

    protected TriPredicateResultValidatorStrategy(V value, P parentValidator, Result<NoValue> result, O other,
            A another) {
