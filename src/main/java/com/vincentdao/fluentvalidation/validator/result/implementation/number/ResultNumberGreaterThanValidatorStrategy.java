...
public final class ResultNumberGreaterThanValidatorStrategy<P extends AbstractResultValidator<P, V>, V extends Number & Comparable<V>>
        extends BiPredicateResultValidatorStrategy<ResultNumberGreaterThanValidatorStrategy<P, V>, P, V, V> {

    public ResultNumberGreaterThanValidatorStrategy(V value, P parentValidator, Result<NoValue> result, V other) {
    ...
    protected String reason() {
        return String.format("must be greater than %s", other());
    }
}
