...
public final class ResultNumberLessThanOrEqualValidatorStrategy<P extends AbstractResultValidator<P, V>, V extends Number & Comparable<V>>
        extends BiPredicateResultValidatorStrategy<ResultNumberLessThanOrEqualValidatorStrategy<P, V>, P, V, V> {

    public ResultNumberLessThanOrEqualValidatorStrategy(V value, P parentValidator, Result<NoValue> result,
            V other) {
    ...
    protected String reason() {
        return String.format("must be less than or equal ", other());
    }
}
