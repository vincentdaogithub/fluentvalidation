...
public final class ResultNumberLessThanValidatorStrategy<P extends AbstractResultValidator<P, V>, V extends Number & Comparable<V>>
        extends BiPredicateResultValidatorStrategy<ResultNumberLessThanValidatorStrategy<P, V>, P, V, V> {

    public ResultNumberLessThanValidatorStrategy(V value, P parentValidator, Result<NoValue> result,
            V other) {
    ...
    protected String reason() {
        return String.format("must be less than %s", other());
    }
}
